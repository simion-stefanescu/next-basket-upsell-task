...
router.post("/:tenant_id/checkout/:cart_id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { promoCode, upsellEnabled } = req.body;
    const cart = (0, cartService_1.getCart)(req.params.tenant_id, req.params.cart_id);
    if (!cart)
    ...
    const { order, error } = (0, checkoutService_1.checkoutCart)(req.params.tenant_id, cart, promoCode, upsell);
    if (error)
